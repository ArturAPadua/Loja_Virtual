<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="formTabelaProdutos.aspx.cs" Inherits="LojaVirtual.UI.formTableProdutos" %>
               ...
               OnRowUpdating="GridProdutos_RowUpdating"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Categoria">
                        <ItemTemplate>
                            <asp:Label ID="labelCategoria" runat="server" Text='<%# Eval("categoria")%>'>
                            </asp:Label>
                        </ItemTemplate>
                    </asp:TemplateField>

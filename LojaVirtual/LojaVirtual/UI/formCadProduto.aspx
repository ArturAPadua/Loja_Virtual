    ...
    <main>
        <form id="form1" runat="server">
            ...
            <div>
                ...
                <div>
                    <asp:Label for="categoriaId" Text="CategoriaId" runat="server"></asp:Label>
                    <asp:DropDownList ID="categoriaId" runat="server"></asp:DropDownList>
                </div>
                <div>
                    <asp:Label for="fornecedorId" Text="FornecedorId" runat="server"></asp:Label>
                    <asp:DropDownList ID="fornecedorId" runat="server"></asp:DropDownList>
                </div>
                <div>
                    <asp:Label for="quatidadeEstoque" Text="QuantidadeEstoque" runat="server"></asp:Label>
                    <asp:TextBox ID="quantidadeEstoque" runat="server"></asp:TextBox>
                </div>
                <div>
